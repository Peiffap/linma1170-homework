...
def data_analysis(precision='report'):
    ...
    plt.ylabel(r"Condition number of $A$")
    plt.title(r"Influence of clscale on the condition number of $A$"
              "\n"
              "Pearson correlation coefficient : %f" %clscale_condition_corr[0])
