...
def mysolve(A, b):
    ...
    this solver uses either:
        ...
        * numpy.linalg's built-in solver;
        * a solver based on QR factorization (not implemented);
        * an in-place solver based on LU factorization;
        * a solver based on the GMRES algorithm (not implemented).
